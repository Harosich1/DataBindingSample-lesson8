...
class SimpleViewModel : ViewModel() {
    private val _name = MutableLiveData("Artom")
    private val _lastname = MutableLiveData("God-Orenko")
    private val _likes = MutableLiveData(0)

    val name : LiveData<String> = _name
    val lastName : LiveData<String> = _lastname

    var likes : LiveData<Int> = _likes/* making likes into observable state(live data) */
